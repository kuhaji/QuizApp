...
class QuizQuestionsActivity : AppCompatActivity(), View.OnClickListener {
    ...
    //making variables for questions list and answers to them
    private var mCurrentPosition: Int = 1
    private var mQuestionsList: ArrayList<Question>? = null
    private var mSelectedOptionPosition: Int = 0
    //this tells how many correct answers are
    ...
    //This makes buttons highlighted when you click them
    ...
    //when you choose option, this will show after pressing submit button that is answer correct with color
